const PollutantInfo = ({pollutant}) => {
    const getPollutantInfo = (pollutant) => {
        switch (pollutant) {
            ...
            case 'o3':
              return 'Ozone (O3) is a gas that occurs both in the Earth\'s upper atmosphere and at ground level. It can be good or bad for health and the environment, depending on it\'s location in the atmosphere.';
            case 'no2':
              return 'Nitrogen Dioxide (NO2) primarily gets into the air from burning fuel. It can cause respiratory problems and contribute to the formation of other pollutants.';
            case 'so2':
